...
`colorChange` ფუნქცია სტატიკურია. სტატიკური მეთოდები შექმნილია იმისათვის, რომ იარსებონ მხოლოდ იმ კონსტრუქტორზე, რომელშიც ისინი იქმნება და არ შეიძლება გადაეცეს რომელიმე შვილს ან გამოიძახოს კლასის ინსტანციებზე. ვინაიდან `freddie` არის `Chameleon` კლასის ინსტანცია, მასზე ფუნქციის გამოძახება შეუძლებელია. ამოგვიგდებს `TypeError`. 
